<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Principal.Master" AutoEventWireup="true" CodeBehind="ADMIS_ReimprimirFormRegistro.aspx.cs" Inherits="SisAdmisiones.Forms.ADMIS_ReimprimirFormRegistro" %>
        ...
        <ContentTemplate>
            <div class="row">
	            <div class="col-xs-12 col-md-6 pull-left">
		            <h1>Reimpresión de formularios</h1>
	            </div>      
            </div>
            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                 ...
                                 <div class="row mb-3 ml-2">
                                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                        <div class="form-group">
                                            <div class="form-inline">
                                                <strong><asp:Label ID="lblLugarInscripcion" runat="server" >Lugar de inscripción:</asp:Label></strong>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            <div class="form-inline">
                                                <asp:DropDownList ID="ddlLugarInscripcion" runat="server" CssClass="form-control" AutoPostBack="false" Enabled="false"></asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <asp:Panel ID="pnCarreras" runat="server" Visible="true">
                                ...
                                <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            <div class="form-inline">
                                                <asp:DropDownList ID="ddlCarreras" runat="server" CssClass="form-control" AutoPostBack="True" Enabled="false" OnSelectedIndexChanged="ddlCarreras_SelectedIndexChanged"></asp:DropDownList>
                                            </div>
                                        </div>
                            ...
                            <asp:Panel ID="pnPensums" runat="server" Visible="false">
                                ...
                                <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                                     ...
                                     <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            <div class="form-inline">
                                                <asp:DropDownList ID="ddlPensumIngreso" runat="server" CssClass="form-control" Enabled="false" AutoPostBack="True"></asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                    </div>
			        ...
			        <div class="panel-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbPrimerApellido" runat="server" CssClass="form-control" MaxLength="40" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbSegundoApellido" runat="server" CssClass="form-control" MaxLength="40" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbNombres" runat="server" CssClass="form-control" MaxLength="50" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbDocIdentidad" runat="server" CssClass="form-control" MaxLength="20" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:DropDownList ID="ddlTipoDocIdentidad" runat="server" CssClass="form-control" Enabled="false" AutoPostBack="True"></asp:DropDownList>
                                </div>
                                <div class="col-xs-12 text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12 text-center">
                                            <asp:DropDownList ID="ddlGrupoSangre" runat="server" CssClass="form-control" AutoPostBack="True" Enabled="false"></asp:DropDownList>
                                </div>
                                <div class="col-xs-12 text-center">
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:DropDownList ID="ddlGenero" runat="server" CssClass="form-control" AutoPostBack="True" Enabled="false"></asp:DropDownList>
                                </div>
                                <div class="col-xs-12 text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:DropDownList ID="ddlEstadoCivil" runat="server" CssClass="form-control" Enabled="false" AutoPostBack="True"></asp:DropDownList>
                                </div>
                                <div class="col-xs-12 text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:DropDownList ID="ddlDiscapacidad" runat="server" CssClass="form-control" Enabled="false" AutoPostBack="True"></asp:DropDownList>
                                </div>
                                <div class="col-xs-12 text-center">
		        ...
		        <div class="panel panel-info">
			        ...
			        <div class="panel-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbFechaNac" runat="server" TextMode="Date" max="2010-12-31" min="1940-01-01" MaxLength="10" Enabled="false" CssClass="form-control" AutoCompleteType="Disabled" ></asp:TextBox>
                                </div>
                                <div class="col-xs-12 text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:DropDownList ID="ddlPaisNac" runat="server" CssClass="form-control" Enabled="false" OnSelectedIndexChanged="ddlPaisNac_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                                </div>
                                <div class="col-xs-12 text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:DropDownList ID="ddlEstadoNac" runat="server" CssClass="form-control" Enabled="false" OnSelectedIndexChanged="ddlEstadoNac_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                                </div>
                                <div class="col-xs-12 text-center">
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:DropDownList ID="ddlCiudadNac" runat="server" CssClass="form-control" Enabled="false" OnSelectedIndexChanged="ddlCiudadNac_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                                </div>
                                <div class="col-xs-12 text-center">
                             ...
                             <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                    <div class="col-xs-12">
                                        <asp:DropDownList ID="ddlAreaNacimiento" runat="server" CssClass="form-control" Enabled="false" AutoPostBack="True"></asp:DropDownList>
                                    </div>
                                    <div class="col-xs-12 text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:DropDownList ID="ddlNacionalidad" runat="server" CssClass="form-control" Enabled="false" AutoPostBack="True"></asp:DropDownList>
                                </div>
                                <div class="col-xs-12 text-center">
			        ...
			        <div class="panel-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-7 col-md-5 col-lg-5">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbCalleAvenida" runat="server" CssClass="form-control" MaxLength="250" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbNumeroDom" runat="server" CssClass="form-control" MaxLength="20" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                            ...
                            <div class="col-xs-12 col-sm-5 col-md-3 col-lg-3">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbZona" runat="server" CssClass="form-control" MaxLength="60" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-2 col-lg-2">
                                    <div class="col-xs-12">
                                        <asp:DropDownList ID="ddlLocalidadZona" runat="server" CssClass="form-control" AutoPostBack="false" Enabled="false"></asp:DropDownList>
                                    </div>
                                    <div class="col-xs-12 text-center">
                                        <strong><asp:Label ID="lblLocalidadZona" runat="server" >Ubicación domicilio</asp:Label></strong>
                                    </div>
                                </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-7 col-md-6 col-lg-5">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbNombreEdificio" runat="server" CssClass="form-control" MaxLength="60" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                            ...
                            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbPiso" runat="server" CssClass="form-control" MaxLength="60" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                           ...
                           <div class="col-xs-12 col-sm-5 col-md-3 col-lg-2">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbNumeroDepto" runat="server" CssClass="form-control" MaxLength="20" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                                <div class="col-xs-12">
                                      <asp:DropDownList ID="ddlViveCon" runat="server" CssClass="form-control" Enabled="false" AutoPostBack="True"></asp:DropDownList>
                                </div>
                                <div class="col-xs-12 text-center">
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbEmail" runat="server" CssClass="form-control" TextMode="Email" MaxLength="50" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                           ...
                           <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbCelular" runat="server" CssClass="form-control"  MaxLength="9" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbTelefonoDomicilio" runat="server" CssClass="form-control" MaxLength="8" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
		        ...
		        <div class="panel panel-info">
			        ...
			        <div class="panel-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:DropDownList ID="ddlPaisBach" runat="server" Enabled="false" OnSelectedIndexChanged="ddlPaisBach_SelectedIndexChanged" CssClass="form-control" AutoPostBack="True"></asp:DropDownList>
                                </div>
                                <div class="col-xs-12 text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:DropDownList ID="ddlEstadoBach" runat="server" Enabled="false" OnSelectedIndexChanged="ddlEstadoBach_SelectedIndexChanged" CssClass="form-control" AutoPostBack="True"></asp:DropDownList>
                                </div>
                                <div class="col-xs-12 text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                   <asp:DropDownList ID="ddlCiudadBach" runat="server" Enabled="false" OnSelectedIndexChanged="ddlCiudadBach_SelectedIndexChanged" CssClass="form-control" AutoPostBack="True"></asp:DropDownList>
                                </div>
                                <div class="col-xs-12 text-center">
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                    <div class="col-xs-12">
                                        <asp:DropDownList ID="ddlAreaColegio" runat="server" CssClass="form-control" Enabled="false" AutoPostBack="True"></asp:DropDownList>
                                    </div>
                                    <div class="col-xs-12 text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                    <div class="col-xs-12">
                                        <asp:DropDownList ID="ddlTipoColegio" runat="server" CssClass="form-control" Enabled="false" AutoPostBack="True"></asp:DropDownList>
                                    </div>
                                    <div class="col-xs-12 text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                    <div class="col-xs-12">
                                        <asp:DropDownList ID="ddlTurno" runat="server" CssClass="form-control" Enabled="false" AutoPostBack="True"></asp:DropDownList>
                                    </div>
                                    <div class="col-xs-12 text-center">
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="col-xs-12">
                                      <asp:DropDownList ID="ddlColegio" runat="server" CssClass="form-control" Enabled="false" AutoPostBack="True"></asp:DropDownList>
                                </div>
                                <div class="col-xs-12 text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                                <div class="col-xs-12">
                                     <asp:DropDownList ID="ddlAnio" runat="server" CssClass="form-control" Enabled="false" AutoPostBack="True"></asp:DropDownList>
                                </div>
                                <div class="col-xs-12 text-center">
		        ...
		        <div class="panel panel-info">
			        ...
			        <div class="panel-body">
                        ...
                        <div class="row mb-5">
                            <div class="col-xs-12">
                                ...
                                <div class="col-sm-5 col-md-4 col-lg-3">
                                       <asp:DropDownList ID="ddlParentesco" runat="server" CssClass="form-control" Enabled="false" AutoPostBack="True"></asp:DropDownList>
                                </div>
                                ...
                                <div class="col-sm-5 col-md-3 col-lg-2">
                                      <div class="col-xs-6 text-center">
                                        <asp:RadioButton id="rbSi" GroupName="Seguimiento" Text="Si" Enabled="false" runat="server" Checked="true"/>
                                      </div>   
                                      <div class="col-xs-6 text-center">
                                        <asp:RadioButton id="rbNo" GroupName="Seguimiento" Text="No" Enabled="false" runat="server"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbPrimerApTutor" runat="server" CssClass="form-control" MaxLength="40" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbSegundoApTutor" runat="server" CssClass="form-control" MaxLength="40" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbNombreTutor" runat="server" CssClass="form-control" MaxLength="50" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbDocIdentidadTutor" runat="server" CssClass="form-control" MaxLength="20" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:DropDownList ID="ddlTipoDocIdentidadTutor" runat="server" CssClass="form-control" Enabled="false" AutoPostBack="True"></asp:DropDownList>
                                </div>
                                <div class="col-xs-12 text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:DropDownList ID="ddlGeneroTutor" runat="server" CssClass="form-control" Enabled="false" AutoPostBack="True" ></asp:DropDownList>
                                </div>
                                <div class="col-xs-12 text-center">
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-8 col-md-7 col-lg-5">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbCalleAvenidaTutor" runat="server" CssClass="form-control" MaxLength="250" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-5 col-lg-3">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbNumeroDomTutor" runat="server" CssClass="form-control" MaxLength="20" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                    <asp:TextBox ID="tbZonaTutor" runat="server" CssClass="form-control" MaxLength="60" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-8 col-md-7 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbEdificioTutor" runat="server" CssClass="form-control" MaxLength="60" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                           ...
                           <div class="col-xs-12 col-sm-4 col-md-5 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbDeptoTutor" runat="server" CssClass="form-control" MaxLength="20" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-6">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbEmailTutor" runat="server" CssClass="form-control" TextMode="Email" MaxLength="50" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                           ...
                           <div class="col-xs-12 col-sm-5 col-md-5 col-lg-3">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbCelularTutor" runat="server" CssClass="form-control"  MaxLength="9" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                            ...
                            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-3">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbTelefonoTutor" runat="server" CssClass="form-control" MaxLength="8" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbInstitucionLaboralTutor" runat="server" CssClass="form-control" MaxLength="100" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbCargoTutor" runat="server" CssClass="form-control" MaxLength="100" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbTelefonoOficina" runat="server" CssClass="form-control" MaxLength="9" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
			        ...
			        <div class="panel-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-8">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbNombreCompleto" runat="server" CssClass="form-control" MaxLength="150" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="col-xs-12">
                                      <asp:TextBox ID="tbTelefonoContacto1" runat="server" CssClass="form-control" MaxLength="20" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                 <div class="col-xs-12">
                                      <asp:TextBox ID="tbTelefonoContacto2" runat="server" CssClass="form-control" MaxLength="20" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
            ...
            <asp:Panel ID="pnObservaciones" runat="server" Visible="false">
		        <div class="panel panel-info">
			        ...
			        <div class="panel-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-xs-12">
                                ...
                                <asp:TextBox ID="tbObservaciones" runat="server" CssClass="form-control" TextMode="MultiLine" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox>
                    ...
                    <div class="panel-footer">
                        <div class="btn-toolbar" role="toolbar">
                           <div class="btn-group center-block">
                               <asp:Button ID="btnEnviar" runat="server" CssClass="btn btn-warning btn-default btn-block" Text="Imprimir" OnClick="btnEnviar_Click" CausesValidation="false"  ForeColor="White" />
                            </div>
                          </div>
                        </div>
			   </div>
